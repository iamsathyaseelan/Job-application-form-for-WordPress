...
if ( ! class_exists( 'Job_Application_Form_Public' ) ) {
	...
	class Job_Application_Form_Public {
		...
		public function __construct() {
			...
			add_action( 'wp_ajax_submit_job_application_form', array(
				$this,
				'handle_job_application_form_submission'
			) );
			add_action( 'wp_ajax_nopriv_submit_job_application_form', array(
				$this,
				'handle_job_application_form_submission'
			) );
		}
		...
		public function handle_job_application_form_submission() {
			...
			// Upload the CV.
			$cv_upload = wp_handle_upload( $_FILES['cv'], array( 'action' => 'submit_job_application_form' ) );
			...
			$insert_status = $wpdb->insert( "{$wpdb->prefix}applicant_submissions", array(
